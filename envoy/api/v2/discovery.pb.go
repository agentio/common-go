...
var file_envoy_api_v2_discovery_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x89, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x1c, 0x12,
	...
	0x01, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67,
...
func file_envoy_api_v2_discovery_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_discovery_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_discovery_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_discovery_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_discovery_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_discovery_proto_msgTypes[4].Exporter = func(v any, i int) any {
