...
import (
	...
	auth "github.com/agentio/common-go/envoy/api/v2/auth"
	cluster "github.com/agentio/common-go/envoy/api/v2/cluster"
...
var file_envoy_api_v2_cluster_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x84, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x19, 0x12, 0x17, 0x65, 0x6e, 0x76, 0x6f,
	...
	0x6f, 0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
func file_envoy_api_v2_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_cluster_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_cluster_proto_msgTypes[19].Exporter = func(v any, i int) any {
