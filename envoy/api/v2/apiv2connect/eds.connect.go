...
var (
	endpointDiscoveryServiceServiceDescriptor               = v2.File_envoy_api_v2_eds_proto.Services().ByName("EndpointDiscoveryService")
...
type EndpointDiscoveryServiceClient interface {
	...
	StreamEndpoints(context.Context) *connect.BidiStreamForClient[v2.DiscoveryRequest, v2.DiscoveryResponse]
	DeltaEndpoints(context.Context) *connect.BidiStreamForClient[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse]
	FetchEndpoints(context.Context, *connect.Request[v2.DiscoveryRequest]) (*connect.Response[v2.DiscoveryResponse], error)
}

// NewEndpointDiscoveryServiceClient constructs a client for the
// envoy.api.v2.EndpointDiscoveryService service. By default, it uses the Connect protocol with the
...
func NewEndpointDiscoveryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EndpointDiscoveryServiceClient {
	...
	return &endpointDiscoveryServiceClient{
		streamEndpoints: connect.NewClient[v2.DiscoveryRequest, v2.DiscoveryResponse](
			httpClient,
		...
		deltaEndpoints: connect.NewClient[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse](
			httpClient,
		...
		fetchEndpoints: connect.NewClient[v2.DiscoveryRequest, v2.DiscoveryResponse](
			httpClient,
...
type endpointDiscoveryServiceClient struct {
	streamEndpoints *connect.Client[v2.DiscoveryRequest, v2.DiscoveryResponse]
	deltaEndpoints  *connect.Client[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse]
	fetchEndpoints  *connect.Client[v2.DiscoveryRequest, v2.DiscoveryResponse]
}

// StreamEndpoints calls envoy.api.v2.EndpointDiscoveryService.StreamEndpoints.
func (c *endpointDiscoveryServiceClient) StreamEndpoints(ctx context.Context) *connect.BidiStreamForClient[v2.DiscoveryRequest, v2.DiscoveryResponse] {
	return c.streamEndpoints.CallBidiStream(ctx)
}

// DeltaEndpoints calls envoy.api.v2.EndpointDiscoveryService.DeltaEndpoints.
func (c *endpointDiscoveryServiceClient) DeltaEndpoints(ctx context.Context) *connect.BidiStreamForClient[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse] {
	return c.deltaEndpoints.CallBidiStream(ctx)
}

// FetchEndpoints calls envoy.api.v2.EndpointDiscoveryService.FetchEndpoints.
func (c *endpointDiscoveryServiceClient) FetchEndpoints(ctx context.Context, req *connect.Request[v2.DiscoveryRequest]) (*connect.Response[v2.DiscoveryResponse], error) {
	return c.fetchEndpoints.CallUnary(ctx, req)
}

// EndpointDiscoveryServiceHandler is an implementation of the envoy.api.v2.EndpointDiscoveryService
// service.
type EndpointDiscoveryServiceHandler interface {
	// The resource_names field in DiscoveryRequest specifies a list of clusters
	// to subscribe to updates for.
	StreamEndpoints(context.Context, *connect.BidiStream[v2.DiscoveryRequest, v2.DiscoveryResponse]) error
	DeltaEndpoints(context.Context, *connect.BidiStream[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse]) error
	FetchEndpoints(context.Context, *connect.Request[v2.DiscoveryRequest]) (*connect.Response[v2.DiscoveryResponse], error)
}
...
func NewEndpointDiscoveryServiceHandler(svc EndpointDiscoveryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.api.v2.EndpointDiscoveryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEndpointDiscoveryServiceHandler) StreamEndpoints(context.Context, *connect.BidiStream[v2.DiscoveryRequest, v2.DiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.api.v2.EndpointDiscoveryService.StreamEndpoints is not implemented"))
}
...
func (UnimplementedEndpointDiscoveryServiceHandler) DeltaEndpoints(context.Context, *connect.BidiStream[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.api.v2.EndpointDiscoveryService.DeltaEndpoints is not implemented"))
}
...
func (UnimplementedEndpointDiscoveryServiceHandler) FetchEndpoints(context.Context, *connect.Request[v2.DiscoveryRequest]) (*connect.Response[v2.DiscoveryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envoy.api.v2.EndpointDiscoveryService.FetchEndpoints is not implemented"))
}
