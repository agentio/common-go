...
var file_envoy_api_v2_core_protocol_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x42, 0x86, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x16, 0x12, 0x14, 0x65, 0x6e,
	...
	0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67, 0x69,
...
func file_envoy_api_v2_core_protocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_core_protocol_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_protocol_proto_msgTypes[8].Exporter = func(v any, i int) any {
