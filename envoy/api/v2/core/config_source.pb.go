...
var file_envoy_api_v2_core_config_source_proto_rawDesc = []byte{
	...
	0x1a, 0x02, 0x08, 0x01, 0x12, 0x06, 0x0a, 0x02, 0x56, 0x33, 0x10, 0x02, 0x42, 0x8a, 0x01, 0xf2,
	...
	0x69, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_envoy_api_v2_core_config_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_core_config_source_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_config_source_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_config_source_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_config_source_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_config_source_proto_msgTypes[4].Exporter = func(v any, i int) any {
