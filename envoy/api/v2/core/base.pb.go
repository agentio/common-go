...
var file_envoy_api_v2_core_base_proto_rawDesc = []byte{
	...
	0x4f, 0x55, 0x54, 0x42, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x42, 0x82, 0x01, 0xf2, 0x98, 0xfe,
	...
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e,
	0x74, 0x69, 0x6f, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e,
	0x76, 0x6f, 0x79, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x50,
...
func file_envoy_api_v2_core_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_core_base_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_api_v2_core_base_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_base_proto_msgTypes[17].Exporter = func(v any, i int) any {
