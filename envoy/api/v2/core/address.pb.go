...
var file_envoy_api_v2_core_address_proto_rawDesc = []byte{
	...
	0x80, 0x01, 0x52, 0x09, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x4c, 0x65, 0x6e, 0x42, 0x85, 0x01,
...
func file_envoy_api_v2_core_address_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_core_address_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pipe); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_api_v2_core_address_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_address_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_address_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_address_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_core_address_proto_msgTypes[5].Exporter = func(v any, i int) any {
