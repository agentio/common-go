...
var file_envoy_api_v2_endpoint_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x86, 0x01, 0xf2,
	...
	0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x3b,
...
func file_envoy_api_v2_endpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_endpoint_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_endpoint_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_endpoint_proto_msgTypes[3].Exporter = func(v any, i int) any {
