...
import (
	...
	listener "github.com/agentio/common-go/envoy/api/v2/listener"
	v21 "github.com/agentio/common-go/envoy/config/filter/accesslog/v2"
	v2 "github.com/agentio/common-go/envoy/config/listener/v2"
...
var file_envoy_api_v2_listener_proto_rawDesc = []byte{
	...
	0x4c, 0x59, 0x10, 0x01, 0x4a, 0x04, 0x08, 0x0e, 0x10, 0x0f, 0x42, 0x86, 0x01, 0xf2, 0x98, 0xfe,
...
func file_envoy_api_v2_listener_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_listener_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_listener_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_listener_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_listener_proto_msgTypes[3].Exporter = func(v any, i int) any {
