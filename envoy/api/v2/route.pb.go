...
var file_envoy_api_v2_route_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x80, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05,
...
func file_envoy_api_v2_route_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_route_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_route_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Vhds); i {
			case 0:
				return &v.state
			case 1:
