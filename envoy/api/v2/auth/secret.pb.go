...
var file_envoy_api_v2_auth_secret_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x72, 0x65, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0x99, 0x01,
	...
	0x65, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x69, 0x2f, 0x76, 0x32, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_envoy_api_v2_auth_secret_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_auth_secret_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_auth_secret_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_auth_secret_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Secret); i {
			case 0:
				return &v.state
			case 1:
