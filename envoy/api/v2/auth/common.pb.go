...
var file_envoy_api_v2_auth_common_proto_rawDesc = []byte{
	...
	0x10, 0x01, 0x42, 0x99, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2b, 0x12, 0x29, 0x65, 0x6e, 0x76,
	...
	0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e,
	...
	0x6f, 0x79, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06,
...
func file_envoy_api_v2_auth_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_api_v2_auth_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_auth_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_auth_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_auth_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_api_v2_auth_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
