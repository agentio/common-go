...
var file_envoy_extensions_health_checkers_thrift_v3_thrift_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x42, 0xa3, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10,
	...
	0x69, 0x66, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68,
	...
	0x2f, 0x76, 0x33, 0x3b, 0x74, 0x68, 0x72, 0x69, 0x66, 0x74, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_health_checkers_thrift_v3_thrift_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_health_checkers_thrift_v3_thrift_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Thrift); i {
			case 0:
				return &v.state
			case 1:
