...
import (
	v3 "github.com/agentio/common-go/envoy/extensions/geoip_providers/common/v3"
...
var file_envoy_extensions_geoip_providers_maxmind_v3_maxmind_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0xaf, 0x01, 0xba, 0x80, 0xc8,
...
func file_envoy_extensions_geoip_providers_maxmind_v3_maxmind_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_geoip_providers_maxmind_v3_maxmind_proto_msgTypes[0].Exporter = func(v any, i int) any {
