...
import (
	v3 "github.com/agentio/common-go/envoy/extensions/transport_sockets/raw_buffer/v3"
...
var file_envoy_extensions_transport_sockets_starttls_v3_starttls_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x42, 0xaf, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x3c,
	...
	0x61, 0x72, 0x74, 0x74, 0x6c, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x56, 0x67,
...
func file_envoy_extensions_transport_sockets_starttls_v3_starttls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_transport_sockets_starttls_v3_starttls_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_transport_sockets_starttls_v3_starttls_proto_msgTypes[1].Exporter = func(v any, i int) any {
