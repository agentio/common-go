...
var file_envoy_extensions_transport_sockets_alts_v3_alts_proto_rawDesc = []byte{
	...
	0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x2e, 0x41, 0x6c, 0x74, 0x73, 0x42, 0x9f, 0x01, 0xba, 0x80,
	...
	0x42, 0x09, 0x41, 0x6c, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4e, 0x67,
	...
	0x6c, 0x74, 0x73, 0x2f, 0x76, 0x33, 0x3b, 0x61, 0x6c, 0x74, 0x73, 0x76, 0x33, 0x62, 0x06, 0x70,
...
func file_envoy_extensions_transport_sockets_alts_v3_alts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_transport_sockets_alts_v3_alts_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Alts); i {
			case 0:
				return &v.state
			case 1:
