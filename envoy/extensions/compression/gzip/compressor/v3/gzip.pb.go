...
var file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDesc = []byte{
	...
	0x01, 0x42, 0xaf, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x3d, 0x69, 0x6f,
	...
	0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x59, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
func file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Gzip); i {
			case 0:
				return &v.state
			case 1:
