...
var file_envoy_extensions_compression_gzip_decompressor_v3_gzip_proto_rawDesc = []byte{
	...
	0x78, 0x49, 0x6e, 0x66, 0x6c, 0x61, 0x74, 0x65, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x42, 0xb5, 0x01,
...
func file_envoy_extensions_compression_gzip_decompressor_v3_gzip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_compression_gzip_decompressor_v3_gzip_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Gzip); i {
			case 0:
				return &v.state
			case 1:
