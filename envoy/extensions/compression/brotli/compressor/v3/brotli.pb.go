...
var file_envoy_extensions_compression_brotli_compressor_v3_brotli_proto_rawDesc = []byte{
	...
	0x08, 0x0a, 0x04, 0x46, 0x4f, 0x4e, 0x54, 0x10, 0x03, 0x42, 0xb5, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_extensions_compression_brotli_compressor_v3_brotli_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_compression_brotli_compressor_v3_brotli_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Brotli); i {
			case 0:
				return &v.state
			case 1:
