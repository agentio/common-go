...
var file_envoy_extensions_compression_brotli_decompressor_v3_brotli_proto_rawDesc = []byte{
	...
	0x28, 0x80, 0x20, 0x52, 0x09, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x42, 0xbb,
	...
	0x6f, 0x74, 0x6c, 0x69, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x5f, 0x67, 0x69, 0x74,
	...
	0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x6f, 0x72, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_compression_brotli_decompressor_v3_brotli_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_compression_brotli_decompressor_v3_brotli_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Brotli); i {
			case 0:
				return &v.state
			case 1:
