...
var file_envoy_extensions_compression_zstd_decompressor_v3_zstd_proto_rawDesc = []byte{
	...
	0x53, 0x69, 0x7a, 0x65, 0x42, 0xb5, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a,
	...
	0x42, 0x09, 0x5a, 0x73, 0x74, 0x64, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x5d, 0x67,
...
func file_envoy_extensions_compression_zstd_decompressor_v3_zstd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_compression_zstd_decompressor_v3_zstd_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Zstd); i {
			case 0:
				return &v.state
			case 1:
