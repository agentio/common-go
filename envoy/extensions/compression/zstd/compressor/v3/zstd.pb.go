...
var file_envoy_extensions_compression_zstd_compressor_v3_zstd_proto_rawDesc = []byte{
	...
	0x54, 0x55, 0x4c, 0x54, 0x52, 0x41, 0x32, 0x10, 0x09, 0x42, 0xaf, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_extensions_compression_zstd_compressor_v3_zstd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_compression_zstd_compressor_v3_zstd_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Zstd); i {
			case 0:
				return &v.state
			case 1:
