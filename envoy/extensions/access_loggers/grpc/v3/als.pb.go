...
import (
	...
	v31 "github.com/agentio/common-go/envoy/type/tracing/v3"
...
var file_envoy_extensions_access_loggers_grpc_v3_als_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x47, 0x72, 0x70, 0x63, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f, 0x67, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x98, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02,
...
func file_envoy_extensions_access_loggers_grpc_v3_als_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_access_loggers_grpc_v3_als_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_access_loggers_grpc_v3_als_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_access_loggers_grpc_v3_als_proto_msgTypes[2].Exporter = func(v any, i int) any {
