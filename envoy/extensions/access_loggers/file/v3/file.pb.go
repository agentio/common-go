...
var file_envoy_extensions_access_loggers_file_v3_file_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x6d, 0x61, 0x74, 0x42, 0x99, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02,
...
func file_envoy_extensions_access_loggers_file_v3_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_access_loggers_file_v3_file_proto_msgTypes[0].Exporter = func(v any, i int) any {
