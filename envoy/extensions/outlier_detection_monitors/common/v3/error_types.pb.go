...
var file_envoy_extensions_outlier_detection_monitors_common_v3_error_types_proto_rawDesc = []byte{
	...
	0xbd, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x43, 0x69, 0x6f, 0x2e, 0x65,
	...
	0x6d, 0x6f, 0x6e, 0x2f, 0x76, 0x33, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x76, 0x33, 0x62,
...
func file_envoy_extensions_outlier_detection_monitors_common_v3_error_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_outlier_detection_monitors_common_v3_error_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_outlier_detection_monitors_common_v3_error_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_outlier_detection_monitors_common_v3_error_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_outlier_detection_monitors_common_v3_error_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
