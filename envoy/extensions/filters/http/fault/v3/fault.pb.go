...
import (
	...
	v31 "github.com/agentio/common-go/envoy/extensions/filters/common/fault/v3"
...
var file_envoy_extensions_filters_http_fault_v3_fault_proto_rawDesc = []byte{
	...
	0x54, 0x50, 0x46, 0x61, 0x75, 0x6c, 0x74, 0x42, 0x99, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
...
func file_envoy_extensions_filters_http_fault_v3_fault_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_fault_v3_fault_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_fault_v3_fault_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_fault_v3_fault_proto_msgTypes[2].Exporter = func(v any, i int) any {
