...
var file_envoy_extensions_filters_http_cors_v3_cors_proto_rawDesc = []byte{
	...
	0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x73, 0x42, 0x95, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
	...
	0x2f, 0x63, 0x6f, 0x72, 0x73, 0x2f, 0x76, 0x33, 0x3b, 0x63, 0x6f, 0x72, 0x73, 0x76, 0x33, 0x62,
...
func file_envoy_extensions_filters_http_cors_v3_cors_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_cors_v3_cors_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Cors); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_cors_v3_cors_proto_msgTypes[1].Exporter = func(v any, i int) any {
