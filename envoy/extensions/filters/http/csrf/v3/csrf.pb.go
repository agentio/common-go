...
var file_envoy_extensions_filters_http_csrf_v3_csrf_proto_rawDesc = []byte{
	...
	0x73, 0x72, 0x66, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x42, 0x95, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_extensions_filters_http_csrf_v3_csrf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_csrf_v3_csrf_proto_msgTypes[0].Exporter = func(v any, i int) any {
