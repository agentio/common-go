...
var file_envoy_extensions_filters_http_compressor_v3_compressor_proto_rawDesc = []byte{
	...
	0x42, 0xad, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x39, 0x69, 0x6f, 0x2e,
...
func file_envoy_extensions_filters_http_compressor_v3_compressor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_compressor_v3_compressor_proto_msgTypes[6].Exporter = func(v any, i int) any {
