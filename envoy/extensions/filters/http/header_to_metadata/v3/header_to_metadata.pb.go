...
var file_envoy_extensions_filters_http_header_to_metadata_v3_header_to_metadata_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x42, 0xcb, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a,
	...
	0x64, 0x61, 0x74, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x65, 0x67, 0x69, 0x74,
...
func file_envoy_extensions_filters_http_header_to_metadata_v3_header_to_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_header_to_metadata_v3_header_to_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_header_to_metadata_v3_header_to_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_header_to_metadata_v3_header_to_metadata_proto_msgTypes[2].Exporter = func(v any, i int) any {
