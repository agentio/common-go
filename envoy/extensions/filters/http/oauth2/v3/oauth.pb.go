...
import (
	...
	v3 "github.com/agentio/common-go/envoy/extensions/transport_sockets/tls/v3"
...
var file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x9c, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02,
	...
	0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73,
	...
	0x68, 0x32, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*OAuth2); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_msgTypes[0].OneofWrappers = []any{
