...
var file_envoy_extensions_filters_http_geoip_v3_geoip_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x54, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x48, 0x6f, 0x70, 0x73, 0x42, 0xa1, 0x01,
...
func file_envoy_extensions_filters_http_geoip_v3_geoip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_geoip_v3_geoip_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Geoip); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_geoip_v3_geoip_proto_msgTypes[1].Exporter = func(v any, i int) any {
