...
var file_envoy_extensions_filters_http_on_demand_v3_on_demand_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x52, 0x05, 0x6f, 0x64, 0x63, 0x64, 0x73, 0x42, 0xa8, 0x01, 0xba, 0x80, 0xc8, 0xd1,
	...
	0x53, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e,
	...
	0x6e, 0x64, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_filters_http_on_demand_v3_on_demand_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_on_demand_v3_on_demand_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_on_demand_v3_on_demand_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_on_demand_v3_on_demand_proto_msgTypes[2].Exporter = func(v any, i int) any {
