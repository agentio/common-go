...
import (
	...
	v3 "github.com/agentio/common-go/envoy/config/accesslog/v3"
...
var file_envoy_extensions_filters_http_router_v3_router_proto_rawDesc = []byte{
	...
	0x32, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x42, 0x9d, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06,
...
func file_envoy_extensions_filters_http_router_v3_router_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_router_v3_router_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Router); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_router_v3_router_proto_msgTypes[1].Exporter = func(v any, i int) any {
