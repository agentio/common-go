...
import (
	v3 "github.com/agentio/common-go/envoy/extensions/common/async_files/v3"
...
var file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0xd3, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0xd2, 0xc6, 0xa4, 0xe1,
	...
	0x5a, 0x65, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65,
	...
	0x75, 0x66, 0x66, 0x65, 0x72, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_msgTypes[7].Exporter = func(v any, i int) any {
