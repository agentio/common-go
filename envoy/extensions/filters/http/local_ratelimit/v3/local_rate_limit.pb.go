...
import (
	...
	v32 "github.com/agentio/common-go/envoy/extensions/common/ratelimit/v3"
...
var file_envoy_extensions_filters_http_local_ratelimit_v3_local_rate_limit_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x78, 0x68, 0x61, 0x75, 0x73, 0x74, 0x65, 0x64, 0x42, 0xc0,
...
func file_envoy_extensions_filters_http_local_ratelimit_v3_local_rate_limit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_local_ratelimit_v3_local_rate_limit_proto_msgTypes[0].Exporter = func(v any, i int) any {
