...
var file_envoy_extensions_filters_http_grpc_field_extraction_v3_config_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x42, 0xca, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x44,
...
func file_envoy_extensions_filters_http_grpc_field_extraction_v3_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_grpc_field_extraction_v3_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_grpc_field_extraction_v3_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_grpc_field_extraction_v3_config_proto_msgTypes[2].Exporter = func(v any, i int) any {
