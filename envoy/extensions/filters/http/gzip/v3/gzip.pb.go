...
import (
	v3 "github.com/agentio/common-go/envoy/extensions/filters/http/compressor/v3"
...
var file_envoy_extensions_filters_http_gzip_v3_gzip_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x42, 0x95, 0x01,
	...
	0x7a, 0x69, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x49, 0x67, 0x69, 0x74, 0x68,
	...
	0x7a, 0x69, 0x70, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_filters_http_gzip_v3_gzip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_gzip_v3_gzip_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Gzip); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_gzip_v3_gzip_proto_msgTypes[1].Exporter = func(v any, i int) any {
