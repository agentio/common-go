...
var file_envoy_extensions_filters_http_tap_v3_tap_proto_rawDesc = []byte{
	...
	0x42, 0x91, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x32, 0x69, 0x6f, 0x2e,
	...
	0x08, 0x54, 0x61, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x47, 0x67, 0x69, 0x74,
...
func file_envoy_extensions_filters_http_tap_v3_tap_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_tap_v3_tap_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Tap); i {
			case 0:
				return &v.state
			case 1:
