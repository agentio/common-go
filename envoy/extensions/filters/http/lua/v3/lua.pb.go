...
var file_envoy_extensions_filters_http_lua_v3_lua_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x64, 0x65, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x91, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_extensions_filters_http_lua_v3_lua_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_lua_v3_lua_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Lua); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_lua_v3_lua_proto_msgTypes[1].Exporter = func(v any, i int) any {
