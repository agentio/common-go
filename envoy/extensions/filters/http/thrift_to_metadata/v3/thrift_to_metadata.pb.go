...
import (
	v3 "github.com/agentio/common-go/envoy/extensions/filters/network/thrift_proxy/v3"
...
var file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_rawDesc = []byte{
	...
	0x10, 0x06, 0x42, 0xcb, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x41, 0x69,
	...
	0x74, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x65, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x2f, 0x68, 0x74, 0x74, 0x70, 0x2f, 0x74, 0x68, 0x72, 0x69, 0x66, 0x74, 0x5f, 0x74, 0x6f, 0x5f,
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x76, 0x33, 0x3b, 0x74, 0x68, 0x72, 0x69,
	0x66, 0x74, 0x5f, 0x74, 0x6f, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x76, 0x33,
...
func file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_msgTypes[4].Exporter = func(v any, i int) any {
