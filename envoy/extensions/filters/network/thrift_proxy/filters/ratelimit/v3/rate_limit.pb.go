...
var file_envoy_extensions_filters_network_thrift_proxy_filters_ratelimit_v3_rate_limit_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x69, 0x74, 0x42, 0xd9, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a,
...
func file_envoy_extensions_filters_network_thrift_proxy_filters_ratelimit_v3_rate_limit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_thrift_proxy_filters_ratelimit_v3_rate_limit_proto_msgTypes[0].Exporter = func(v any, i int) any {
