...
import (
	v32 "github.com/agentio/common-go/envoy/config/accesslog/v3"
...
var file_envoy_extensions_filters_network_generic_proxy_v3_generic_proxy_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0xc6, 0x01, 0xba, 0x80, 0xc8,
...
func file_envoy_extensions_filters_network_generic_proxy_v3_generic_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_generic_proxy_v3_generic_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_generic_proxy_v3_generic_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
