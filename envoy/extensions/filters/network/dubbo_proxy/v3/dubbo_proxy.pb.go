...
var file_envoy_extensions_filters_network_dubbo_proxy_v3_dubbo_proxy_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x69, 0x61, 0x6e, 0x32, 0x10, 0x00, 0x42, 0xb6, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_extensions_filters_network_dubbo_proxy_v3_dubbo_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_dubbo_proxy_v3_dubbo_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Drds); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_filters_network_dubbo_proxy_v3_dubbo_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_dubbo_proxy_v3_dubbo_proxy_proto_msgTypes[2].Exporter = func(v any, i int) any {
