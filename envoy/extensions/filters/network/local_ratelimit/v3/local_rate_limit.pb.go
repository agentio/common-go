...
var file_envoy_extensions_filters_network_local_ratelimit_v3_local_rate_limit_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0xc6, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x41, 0x69, 0x6f,
...
func file_envoy_extensions_filters_network_local_ratelimit_v3_local_rate_limit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_local_ratelimit_v3_local_rate_limit_proto_msgTypes[0].Exporter = func(v any, i int) any {
