...
import (
	...
	v31 "github.com/agentio/common-go/envoy/extensions/common/dynamic_forward_proxy/v3"
...
var file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_rawDesc = []byte{
	...
	0x6f, 0x63, 0x6f, 0x6c, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0xb6, 0x01, 0xba, 0x80,
...
func file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_msgTypes[8].Exporter = func(v any, i int) any {
