...
var file_envoy_extensions_filters_network_wasm_v3_wasm_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x9b, 0x01, 0xba, 0x80,
	...
	0x57, 0x61, 0x73, 0x6d, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4c, 0x67, 0x69, 0x74,
	...
	0x76, 0x33, 0x3b, 0x77, 0x61, 0x73, 0x6d, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_envoy_extensions_filters_network_wasm_v3_wasm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_wasm_v3_wasm_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Wasm); i {
			case 0:
				return &v.state
			case 1:
