...
import (
	v3 "github.com/agentio/common-go/envoy/extensions/filters/common/fault/v3"
...
var file_envoy_extensions_filters_network_mongo_proxy_v3_mongo_proxy_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x42, 0xb6, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
...
func file_envoy_extensions_filters_network_mongo_proxy_v3_mongo_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_filters_network_mongo_proxy_v3_mongo_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
