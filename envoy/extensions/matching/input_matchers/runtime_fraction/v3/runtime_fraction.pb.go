...
var file_envoy_extensions_matching_input_matchers_runtime_fraction_v3_runtime_fraction_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x04, 0x52, 0x04, 0x73, 0x65, 0x65, 0x64, 0x42, 0xda, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_extensions_matching_input_matchers_runtime_fraction_v3_runtime_fraction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_matching_input_matchers_runtime_fraction_v3_runtime_fraction_proto_msgTypes[0].Exporter = func(v any, i int) any {
