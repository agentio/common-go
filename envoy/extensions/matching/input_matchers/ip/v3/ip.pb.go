...
var file_envoy_extensions_matching_input_matchers_ip_v3_ip_proto_rawDesc = []byte{
	...
	0x78, 0x42, 0xa3, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x3c, 0x69, 0x6f,
	...
	0x76, 0x33, 0x3b, 0x69, 0x70, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_matching_input_matchers_ip_v3_ip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_matching_input_matchers_ip_v3_ip_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Ip); i {
			case 0:
				return &v.state
			case 1:
