...
var file_envoy_extensions_matching_common_inputs_ssl_v3_ssl_inputs_proto_rawDesc = []byte{
	...
	0x0a, 0x0c, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x42, 0xab,
	...
	0x73, 0x73, 0x6c, 0x2f, 0x76, 0x33, 0x3b, 0x73, 0x73, 0x6c, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_matching_common_inputs_ssl_v3_ssl_inputs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_matching_common_inputs_ssl_v3_ssl_inputs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_matching_common_inputs_ssl_v3_ssl_inputs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_matching_common_inputs_ssl_v3_ssl_inputs_proto_msgTypes[2].Exporter = func(v any, i int) any {
