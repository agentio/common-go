...
var file_envoy_extensions_matching_common_inputs_environment_variable_v3_input_proto_rawDesc = []byte{
	...
	0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0xda, 0x01,
	...
	0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
func file_envoy_extensions_matching_common_inputs_environment_variable_v3_input_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_matching_common_inputs_environment_variable_v3_input_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
