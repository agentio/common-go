...
import (
	...
	v31 "github.com/agentio/common-go/envoy/extensions/filters/network/http_connection_manager/v3"
...
var file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x9e, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
	...
	0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65,
	...
	0x33, 0x3b, 0x68, 0x74, 0x74, 0x70, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_msgTypes[3].Exporter = func(v any, i int) any {
