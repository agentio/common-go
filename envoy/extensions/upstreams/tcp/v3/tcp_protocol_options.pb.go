...
var file_envoy_extensions_upstreams_tcp_v3_tcp_protocol_options_proto_rawDesc = []byte{
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0x9a, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a,
...
func file_envoy_extensions_upstreams_tcp_v3_tcp_protocol_options_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_upstreams_tcp_v3_tcp_protocol_options_proto_msgTypes[0].Exporter = func(v any, i int) any {
