...
var file_envoy_extensions_rbac_audit_loggers_stream_v3_stream_proto_rawDesc = []byte{
	...
	0x64, 0x6f, 0x75, 0x74, 0x41, 0x75, 0x64, 0x69, 0x74, 0x4c, 0x6f, 0x67, 0x42, 0xa9, 0x01, 0xba,
...
func file_envoy_extensions_rbac_audit_loggers_stream_v3_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_rbac_audit_loggers_stream_v3_stream_proto_msgTypes[0].Exporter = func(v any, i int) any {
