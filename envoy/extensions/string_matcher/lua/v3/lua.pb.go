...
var file_envoy_extensions_string_matcher_lua_v3_lua_proto_rawDesc = []byte{
	...
	0x72, 0x63, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x42, 0x95, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
	...
	0x6f, 0x6e, 0x73, 0x2f, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x5f, 0x6d, 0x61, 0x74, 0x63, 0x68,
	0x65, 0x72, 0x2f, 0x6c, 0x75, 0x61, 0x2f, 0x76, 0x33, 0x3b, 0x6c, 0x75, 0x61, 0x76, 0x33, 0x62,
...
func file_envoy_extensions_string_matcher_lua_v3_lua_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_string_matcher_lua_v3_lua_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Lua); i {
			case 0:
				return &v.state
			case 1:
