...
var file_envoy_extensions_tracers_opentelemetry_samplers_v3_dynatrace_sampler_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x65, 0x42, 0xbf, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x40,
...
func file_envoy_extensions_tracers_opentelemetry_samplers_v3_dynatrace_sampler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_tracers_opentelemetry_samplers_v3_dynatrace_sampler_proto_msgTypes[0].Exporter = func(v any, i int) any {
