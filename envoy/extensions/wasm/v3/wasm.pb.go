...
var file_envoy_extensions_wasm_v3_wasm_proto_rawDesc = []byte{
	...
	0x67, 0x6c, 0x65, 0x74, 0x6f, 0x6e, 0x42, 0x7b, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x77, 0x61, 0x73, 0x6d, 0x2f, 0x76, 0x33, 0x3b, 0x77, 0x61, 0x73,
...
func file_envoy_extensions_wasm_v3_wasm_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[4].OneofWrappers = []any{
