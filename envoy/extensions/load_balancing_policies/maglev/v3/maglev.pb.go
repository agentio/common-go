...
var file_envoy_extensions_load_balancing_policies_maglev_v3_maglev_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x42, 0xb3, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x40, 0x69,
	...
	0x0b, 0x4d, 0x61, 0x67, 0x6c, 0x65, 0x76, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x58,
	...
	0x6d, 0x61, 0x67, 0x6c, 0x65, 0x76, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_extensions_load_balancing_policies_maglev_v3_maglev_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_load_balancing_policies_maglev_v3_maglev_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Maglev); i {
			case 0:
				return &v.state
			case 1:
