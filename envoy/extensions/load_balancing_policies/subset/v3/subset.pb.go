...
var file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x73, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0xb3, 0x01, 0xba, 0x80,
...
func file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Subset); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_msgTypes[1].Exporter = func(v any, i int) any {
