...
import (
	...
	v31 "github.com/agentio/common-go/envoy/extensions/transport_sockets/tls/v3"
...
var file_envoy_extensions_http_injected_credentials_oauth2_v3_oauth2_proto_rawDesc = []byte{
	...
	0x65, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0xbf, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10,
	...
	0x61, 0x75, 0x74, 0x68, 0x32, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x5a, 0x67, 0x69,
	...
	0x2f, 0x69, 0x6e, 0x6a, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x61, 0x6c, 0x73, 0x2f, 0x6f, 0x61, 0x75, 0x74, 0x68, 0x32, 0x2f, 0x76, 0x33, 0x3b,
...
func file_envoy_extensions_http_injected_credentials_oauth2_v3_oauth2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_http_injected_credentials_oauth2_v3_oauth2_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*OAuth2); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_extensions_http_injected_credentials_oauth2_v3_oauth2_proto_msgTypes[1].Exporter = func(v any, i int) any {
