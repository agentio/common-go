...
import (
	...
	v3 "github.com/agentio/common-go/envoy/config/cluster/v3"
	v32 "github.com/agentio/common-go/envoy/config/common/key_value/v3"
...
var file_envoy_extensions_common_dynamic_forward_proxy_v3_dns_cache_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x42, 0xc0, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x3e, 0x69,
	...
	0x6e, 0x73, 0x43, 0x61, 0x63, 0x68, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x65,
...
func file_envoy_extensions_common_dynamic_forward_proxy_v3_dns_cache_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_common_dynamic_forward_proxy_v3_dns_cache_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_common_dynamic_forward_proxy_v3_dns_cache_proto_msgTypes[1].Exporter = func(v any, i int) any {
