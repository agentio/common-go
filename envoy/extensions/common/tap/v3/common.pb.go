...
import (
	v3 "github.com/agentio/common-go/envoy/config/tap/v3"
...
var file_envoy_extensions_common_tap_v3_common_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x88, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06,
...
func file_envoy_extensions_common_tap_v3_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_extensions_common_tap_v3_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_extensions_common_tap_v3_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
