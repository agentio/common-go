...
var file_envoy_annotations_resource_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
...
func file_envoy_annotations_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_annotations_resource_proto_msgTypes[0].Exporter = func(v any, i int) any {
