...
var file_envoy_admin_v2alpha_tap_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x69, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
...
func file_envoy_admin_v2alpha_tap_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v2alpha_tap_proto_msgTypes[0].Exporter = func(v any, i int) any {
