...
import (
	v3 "github.com/agentio/common-go/envoy/config/bootstrap/v3"
...
var file_envoy_admin_v3_config_dump_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x74, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x44, 0x75, 0x6d, 0x70, 0x42, 0x6e,
	...
	0x6d, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x2f, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x61, 0x64,
...
func file_envoy_admin_v3_config_dump_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_config_dump_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_config_dump_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_config_dump_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_config_dump_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_config_dump_proto_msgTypes[4].Exporter = func(v any, i int) any {
