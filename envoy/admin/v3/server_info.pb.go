...
var file_envoy_admin_v3_server_info_proto_rawDesc = []byte{
	...
	0x6e, 0x42, 0x6e, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x1c, 0x69, 0x6f, 0x2e,
	...
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x33, 0x67, 0x69,
...
func file_envoy_admin_v3_server_info_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_server_info_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_server_info_proto_msgTypes[1].Exporter = func(v any, i int) any {
