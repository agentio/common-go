...
var file_envoy_admin_v3_mutex_stats_proto_rawDesc = []byte{
	...
	0x53, 0x74, 0x61, 0x74, 0x73, 0x42, 0x6e, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a,
...
func file_envoy_admin_v3_mutex_stats_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_mutex_stats_proto_msgTypes[0].Exporter = func(v any, i int) any {
