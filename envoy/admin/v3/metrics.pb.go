...
var file_envoy_admin_v3_metrics_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x70, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x42, 0x6b, 0xba, 0x80, 0xc8,
...
func file_envoy_admin_v3_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_metrics_proto_msgTypes[0].Exporter = func(v any, i int) any {
