...
var file_envoy_admin_v3_certs_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x69, 0xba, 0x80, 0xc8,
	...
	0x64, 0x6d, 0x69, 0x6e, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_admin_v3_certs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_certs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_certs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_certs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_certs_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_certs_proto_msgTypes[4].Exporter = func(v any, i int) any {
