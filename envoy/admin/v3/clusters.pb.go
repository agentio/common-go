...
import (
	v31 "github.com/agentio/common-go/envoy/config/cluster/v3"
...
var file_envoy_admin_v3_clusters_proto_rawDesc = []byte{
	...
	0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x6c, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10,
	...
	0x6d, 0x69, 0x6e, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_admin_v3_clusters_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_clusters_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_clusters_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_clusters_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_admin_v3_clusters_proto_msgTypes[3].Exporter = func(v any, i int) any {
