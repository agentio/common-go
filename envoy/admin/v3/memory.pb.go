...
var file_envoy_admin_v3_memory_proto_rawDesc = []byte{
	...
	0x70, 0x68, 0x61, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x6a, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_admin_v3_memory_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_admin_v3_memory_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Memory); i {
			case 0:
				return &v.state
			case 1:
