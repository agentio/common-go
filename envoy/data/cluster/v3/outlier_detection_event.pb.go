...
var file_envoy_data_cluster_v3_outlier_detection_event_proto_rawDesc = []byte{
	...
	0x54, 0x10, 0x01, 0x42, 0x89, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x23,
	...
	0x01, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67,
	...
	0x65, 0x72, 0x2f, 0x76, 0x33, 0x3b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x76, 0x33, 0x62,
...
func file_envoy_data_cluster_v3_outlier_detection_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_data_cluster_v3_outlier_detection_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_data_cluster_v3_outlier_detection_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_data_cluster_v3_outlier_detection_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_data_cluster_v3_outlier_detection_event_proto_msgTypes[3].Exporter = func(v any, i int) any {
