...
var file_envoy_data_tap_v3_common_proto_rawDesc = []byte{
	...
	0x42, 0x6e, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x65,
...
func file_envoy_data_tap_v3_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_data_tap_v3_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Body); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_data_tap_v3_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
