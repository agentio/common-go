...
var file_envoy_data_tap_v2alpha_http_proto_rawDesc = []byte{
	...
	0x5f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x42, 0x70, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x01,
	...
	0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x74, 0x61, 0x70,
	0x2f, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_data_tap_v2alpha_http_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_data_tap_v2alpha_http_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_http_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_http_proto_msgTypes[2].Exporter = func(v any, i int) any {
