...
var file_envoy_data_tap_v2alpha_transport_proto_rawDesc = []byte{
	...
	0x0d, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x70, 0x69, 0x65, 0x63, 0x65, 0x42, 0x75,
	...
	0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65,
...
func file_envoy_data_tap_v2alpha_transport_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_data_tap_v2alpha_transport_proto_msgTypes[6].Exporter = func(v any, i int) any {
