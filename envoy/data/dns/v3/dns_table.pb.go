...
var file_envoy_data_dns_v3_dns_table_proto_rawDesc = []byte{
	...
	0x61, 0x2e, 0x44, 0x6e, 0x73, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x42, 0x70, 0xba, 0x80, 0xc8, 0xd1,
	...
	0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f,
	0x64, 0x6e, 0x73, 0x2f, 0x76, 0x33, 0x3b, 0x64, 0x6e, 0x73, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_data_dns_v3_dns_table_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_data_dns_v3_dns_table_proto_msgTypes[7].Exporter = func(v any, i int) any {
