...
var file_envoy_type_range_proto_rawDesc = []byte{
	...
	0x01, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x42, 0x59, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x01,
...
func file_envoy_type_range_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_range_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_range_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_range_proto_msgTypes[2].Exporter = func(v any, i int) any {
