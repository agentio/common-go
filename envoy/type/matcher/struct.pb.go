...
var file_envoy_type_matcher_struct_proto_rawDesc = []byte{
	...
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x6a, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_type_matcher_struct_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_matcher_struct_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_struct_proto_msgTypes[1].Exporter = func(v any, i int) any {
