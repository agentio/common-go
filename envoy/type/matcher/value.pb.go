...
var file_envoy_type_matcher_value_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x6e, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x69, 0xba, 0x80, 0xc8, 0xd1, 0x06,
	...
	0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x2f, 0x6d, 0x61, 0x74,
...
func file_envoy_type_matcher_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_matcher_value_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_value_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_value_proto_msgTypes[2].Exporter = func(v any, i int) any {
