...
var file_envoy_type_matcher_v3_regex_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x53, 0x75, 0x62, 0x73, 0x74, 0x69, 0x74, 0x75, 0x74, 0x65, 0x42, 0x79, 0xba, 0x80,
	...
	0x2e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x42, 0x0a, 0x52, 0x65, 0x67,
	0x65, 0x78, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75,
...
func file_envoy_type_matcher_v3_regex_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_matcher_v3_regex_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_regex_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_regex_proto_msgTypes[2].Exporter = func(v any, i int) any {
