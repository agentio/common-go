...
var file_envoy_type_matcher_v3_value_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x73, 0x42, 0x79, 0xba, 0x80, 0xc8,
	...
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x42, 0x0a, 0x56, 0x61, 0x6c, 0x75,
...
func file_envoy_type_matcher_v3_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_matcher_v3_value_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_value_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_value_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_value_proto_msgTypes[3].Exporter = func(v any, i int) any {
