...
var file_envoy_type_matcher_v3_metadata_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x42, 0x7c, 0xba,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3c, 0x67,
...
func file_envoy_type_matcher_v3_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_matcher_v3_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
