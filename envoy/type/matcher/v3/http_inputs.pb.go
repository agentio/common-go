...
var file_envoy_type_matcher_v3_http_inputs_proto_rawDesc = []byte{
	...
	0x01, 0x52, 0x0a, 0x71, 0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x42, 0x7e, 0xba,
	...
	0x65, 0x2e, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x2e, 0x76, 0x33, 0x42, 0x0f, 0x48, 0x74,
	0x74, 0x70, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
	0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e,
...
func file_envoy_type_matcher_v3_http_inputs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_matcher_v3_http_inputs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_http_inputs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_http_inputs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_http_inputs_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_type_matcher_v3_http_inputs_proto_msgTypes[4].Exporter = func(v any, i int) any {
