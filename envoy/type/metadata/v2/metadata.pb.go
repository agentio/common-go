...
var file_envoy_type_metadata_v2_metadata_proto_rawDesc = []byte{
	...
	0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x9d, 0x01, 0xf2, 0x98,
	...
	0x3b, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
func file_envoy_type_metadata_v2_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_type_metadata_v2_metadata_proto_msgTypes[6].Exporter = func(v any, i int) any {
