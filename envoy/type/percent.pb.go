...
var file_envoy_type_percent_proto_rawDesc = []byte{
	...
	0x4c, 0x49, 0x4f, 0x4e, 0x10, 0x02, 0x42, 0x5b, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x01,
	...
	0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68,
...
func file_envoy_type_percent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_percent_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_percent_proto_msgTypes[1].Exporter = func(v any, i int) any {
