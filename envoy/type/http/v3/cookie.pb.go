...
var file_envoy_type_http_v3_cookie_proto_rawDesc = []byte{
	...
	0x71, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x20, 0x69, 0x6f, 0x2e, 0x65, 0x6e,
	...
	0x6b, 0x69, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68,
	...
	0x79, 0x70, 0x65, 0x2f, 0x68, 0x74, 0x74, 0x70, 0x2f, 0x76, 0x33, 0x3b, 0x68, 0x74, 0x74, 0x70,
...
func file_envoy_type_http_v3_cookie_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_http_v3_cookie_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Cookie); i {
			case 0:
				return &v.state
			case 1:
