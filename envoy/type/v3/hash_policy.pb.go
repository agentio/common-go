...
var file_envoy_type_v3_hash_policy_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x6b, 0xba,
	...
	0x6f, 0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x74, 0x79, 0x70, 0x65,
...
func file_envoy_type_v3_hash_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_v3_hash_policy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_v3_hash_policy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_v3_hash_policy_proto_msgTypes[2].Exporter = func(v any, i int) any {
