...
var file_envoy_type_v3_range_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x62, 0x6c, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x42, 0x66, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_type_v3_range_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_type_v3_range_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_type_v3_range_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_type_v3_range_proto_msgTypes[2].Exporter = func(v any, i int) any {
