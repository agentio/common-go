...
import (
	v2alpha "github.com/agentio/common-go/envoy/admin/v2alpha"
...
var file_envoy_service_status_v2_csds_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x76, 0x32, 0x42, 0x09, 0x43,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2f, 0x76, 0x32,
	0x3b, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_envoy_service_status_v2_csds_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_status_v2_csds_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_status_v2_csds_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_status_v2_csds_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_status_v2_csds_proto_msgTypes[3].Exporter = func(v any, i int) any {
