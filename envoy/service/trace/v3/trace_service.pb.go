...
var file_envoy_service_trace_v3_trace_service_proto_rawDesc = []byte{
	...
	0x00, 0x28, 0x01, 0x42, 0x80, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x24,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x73, 0x65,
...
var file_envoy_service_trace_v3_trace_service_proto_goTypes = []any{
...
func file_envoy_service_trace_v3_trace_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_trace_v3_trace_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_trace_v3_trace_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_trace_v3_trace_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
