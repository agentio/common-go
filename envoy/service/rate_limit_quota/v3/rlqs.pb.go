...
var file_envoy_service_rate_limit_quota_v3_rlqs_proto_rawDesc = []byte{
	...
	0x01, 0x30, 0x01, 0x42, 0xa1, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0xd2, 0xc6,
	...
	0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x71, 0x75, 0x6f, 0x74, 0x61, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_service_rate_limit_quota_v3_rlqs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_service_rate_limit_quota_v3_rlqs_proto_msgTypes[6].Exporter = func(v any, i int) any {
