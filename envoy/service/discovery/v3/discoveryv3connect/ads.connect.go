...
var (
	aggregatedDiscoveryServiceServiceDescriptor                         = v3.File_envoy_service_discovery_v3_ads_proto.Services().ByName("AggregatedDiscoveryService")
...
type AggregatedDiscoveryServiceClient interface {
	...
	StreamAggregatedResources(context.Context) *connect.BidiStreamForClient[v3.DiscoveryRequest, v3.DiscoveryResponse]
	DeltaAggregatedResources(context.Context) *connect.BidiStreamForClient[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]
}
...
func NewAggregatedDiscoveryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AggregatedDiscoveryServiceClient {
	...
	return &aggregatedDiscoveryServiceClient{
		streamAggregatedResources: connect.NewClient[v3.DiscoveryRequest, v3.DiscoveryResponse](
			httpClient,
		...
		deltaAggregatedResources: connect.NewClient[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse](
			httpClient,
...
type aggregatedDiscoveryServiceClient struct {
	streamAggregatedResources *connect.Client[v3.DiscoveryRequest, v3.DiscoveryResponse]
	deltaAggregatedResources  *connect.Client[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]
}

// StreamAggregatedResources calls
// envoy.service.discovery.v3.AggregatedDiscoveryService.StreamAggregatedResources.
func (c *aggregatedDiscoveryServiceClient) StreamAggregatedResources(ctx context.Context) *connect.BidiStreamForClient[v3.DiscoveryRequest, v3.DiscoveryResponse] {
	return c.streamAggregatedResources.CallBidiStream(ctx)
}

// DeltaAggregatedResources calls
// envoy.service.discovery.v3.AggregatedDiscoveryService.DeltaAggregatedResources.
func (c *aggregatedDiscoveryServiceClient) DeltaAggregatedResources(ctx context.Context) *connect.BidiStreamForClient[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse] {
...
type AggregatedDiscoveryServiceHandler interface {
	// This is a gRPC-only API.
	StreamAggregatedResources(context.Context, *connect.BidiStream[v3.DiscoveryRequest, v3.DiscoveryResponse]) error
	DeltaAggregatedResources(context.Context, *connect.BidiStream[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]) error
}
...
func (UnimplementedAggregatedDiscoveryServiceHandler) StreamAggregatedResources(context.Context, *connect.BidiStream[v3.DiscoveryRequest, v3.DiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.discovery.v3.AggregatedDiscoveryService.StreamAggregatedResources is not implemented"))
}

func (UnimplementedAggregatedDiscoveryServiceHandler) DeltaAggregatedResources(context.Context, *connect.BidiStream[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.discovery.v3.AggregatedDiscoveryService.DeltaAggregatedResources is not implemented"))
}
