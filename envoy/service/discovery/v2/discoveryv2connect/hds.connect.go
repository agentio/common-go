...
var (
	healthDiscoveryServiceServiceDescriptor                 = v2.File_envoy_service_discovery_v2_hds_proto.Services().ByName("HealthDiscoveryService")
...
// HealthDiscoveryServiceClient is a client for the
// envoy.service.discovery.v2.HealthDiscoveryService service.
type HealthDiscoveryServiceClient interface {
	...
	StreamHealthCheck(context.Context) *connect.BidiStreamForClient[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier]
	// TODO(htuch): Unlike the gRPC version, there is no stream-based binding of
	// request/response. Should we add an identifier to the HealthCheckSpecifier
	// to bind with the response?
	FetchHealthCheck(context.Context, *connect.Request[v2.HealthCheckRequestOrEndpointHealthResponse]) (*connect.Response[v2.HealthCheckSpecifier], error)
}

// NewHealthDiscoveryServiceClient constructs a client for the
// envoy.service.discovery.v2.HealthDiscoveryService service. By default, it uses the Connect
...
func NewHealthDiscoveryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthDiscoveryServiceClient {
	...
	return &healthDiscoveryServiceClient{
		streamHealthCheck: connect.NewClient[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier](
			httpClient,
		...
		fetchHealthCheck: connect.NewClient[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier](
			httpClient,
...
type healthDiscoveryServiceClient struct {
	streamHealthCheck *connect.Client[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier]
	fetchHealthCheck  *connect.Client[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier]
}

// StreamHealthCheck calls envoy.service.discovery.v2.HealthDiscoveryService.StreamHealthCheck.
func (c *healthDiscoveryServiceClient) StreamHealthCheck(ctx context.Context) *connect.BidiStreamForClient[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier] {
	return c.streamHealthCheck.CallBidiStream(ctx)
}

// FetchHealthCheck calls envoy.service.discovery.v2.HealthDiscoveryService.FetchHealthCheck.
func (c *healthDiscoveryServiceClient) FetchHealthCheck(ctx context.Context, req *connect.Request[v2.HealthCheckRequestOrEndpointHealthResponse]) (*connect.Response[v2.HealthCheckSpecifier], error) {
...
type HealthDiscoveryServiceHandler interface {
	...
	// invariant?
	// TODO(htuch): Add @amb67's diagram.
	StreamHealthCheck(context.Context, *connect.BidiStream[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier]) error
	// TODO(htuch): Unlike the gRPC version, there is no stream-based binding of
	// request/response. Should we add an identifier to the HealthCheckSpecifier
	// to bind with the response?
	FetchHealthCheck(context.Context, *connect.Request[v2.HealthCheckRequestOrEndpointHealthResponse]) (*connect.Response[v2.HealthCheckSpecifier], error)
...
func NewHealthDiscoveryServiceHandler(svc HealthDiscoveryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.service.discovery.v2.HealthDiscoveryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthDiscoveryServiceHandler) StreamHealthCheck(context.Context, *connect.BidiStream[v2.HealthCheckRequestOrEndpointHealthResponse, v2.HealthCheckSpecifier]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.discovery.v2.HealthDiscoveryService.StreamHealthCheck is not implemented"))
}

func (UnimplementedHealthDiscoveryServiceHandler) FetchHealthCheck(context.Context, *connect.Request[v2.HealthCheckRequestOrEndpointHealthResponse]) (*connect.Response[v2.HealthCheckSpecifier], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.discovery.v2.HealthDiscoveryService.FetchHealthCheck is not implemented"))
}
