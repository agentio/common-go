...
var (
	routeDiscoveryServiceServiceDescriptor                       = v3.File_envoy_service_route_v3_rds_proto.Services().ByName("RouteDiscoveryService")
	...
	virtualHostDiscoveryServiceServiceDescriptor                 = v3.File_envoy_service_route_v3_rds_proto.Services().ByName("VirtualHostDiscoveryService")
...
// RouteDiscoveryServiceClient is a client for the envoy.service.route.v3.RouteDiscoveryService
// service.
type RouteDiscoveryServiceClient interface {
	StreamRoutes(context.Context) *connect.BidiStreamForClient[v31.DiscoveryRequest, v31.DiscoveryResponse]
	DeltaRoutes(context.Context) *connect.BidiStreamForClient[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse]
	FetchRoutes(context.Context, *connect.Request[v31.DiscoveryRequest]) (*connect.Response[v31.DiscoveryResponse], error)
}

// NewRouteDiscoveryServiceClient constructs a client for the
// envoy.service.route.v3.RouteDiscoveryService service. By default, it uses the Connect protocol
...
func NewRouteDiscoveryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RouteDiscoveryServiceClient {
	...
	return &routeDiscoveryServiceClient{
		streamRoutes: connect.NewClient[v31.DiscoveryRequest, v31.DiscoveryResponse](
			httpClient,
		...
		deltaRoutes: connect.NewClient[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse](
			httpClient,
			baseURL+RouteDiscoveryServiceDeltaRoutesProcedure,
			connect.WithSchema(routeDiscoveryServiceDeltaRoutesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		fetchRoutes: connect.NewClient[v31.DiscoveryRequest, v31.DiscoveryResponse](
			httpClient,
...
type routeDiscoveryServiceClient struct {
	streamRoutes *connect.Client[v31.DiscoveryRequest, v31.DiscoveryResponse]
	deltaRoutes  *connect.Client[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse]
	fetchRoutes  *connect.Client[v31.DiscoveryRequest, v31.DiscoveryResponse]
}

// StreamRoutes calls envoy.service.route.v3.RouteDiscoveryService.StreamRoutes.
func (c *routeDiscoveryServiceClient) StreamRoutes(ctx context.Context) *connect.BidiStreamForClient[v31.DiscoveryRequest, v31.DiscoveryResponse] {
	return c.streamRoutes.CallBidiStream(ctx)
}

// DeltaRoutes calls envoy.service.route.v3.RouteDiscoveryService.DeltaRoutes.
func (c *routeDiscoveryServiceClient) DeltaRoutes(ctx context.Context) *connect.BidiStreamForClient[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse] {
	return c.deltaRoutes.CallBidiStream(ctx)
}

// FetchRoutes calls envoy.service.route.v3.RouteDiscoveryService.FetchRoutes.
func (c *routeDiscoveryServiceClient) FetchRoutes(ctx context.Context, req *connect.Request[v31.DiscoveryRequest]) (*connect.Response[v31.DiscoveryResponse], error) {
	return c.fetchRoutes.CallUnary(ctx, req)
}

// RouteDiscoveryServiceHandler is an implementation of the
// envoy.service.route.v3.RouteDiscoveryService service.
type RouteDiscoveryServiceHandler interface {
	StreamRoutes(context.Context, *connect.BidiStream[v31.DiscoveryRequest, v31.DiscoveryResponse]) error
	DeltaRoutes(context.Context, *connect.BidiStream[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse]) error
	FetchRoutes(context.Context, *connect.Request[v31.DiscoveryRequest]) (*connect.Response[v31.DiscoveryResponse], error)
}
...
func NewRouteDiscoveryServiceHandler(svc RouteDiscoveryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.service.route.v3.RouteDiscoveryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRouteDiscoveryServiceHandler) StreamRoutes(context.Context, *connect.BidiStream[v31.DiscoveryRequest, v31.DiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.route.v3.RouteDiscoveryService.StreamRoutes is not implemented"))
}
...
func (UnimplementedRouteDiscoveryServiceHandler) DeltaRoutes(context.Context, *connect.BidiStream[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.route.v3.RouteDiscoveryService.DeltaRoutes is not implemented"))
}
...
func (UnimplementedRouteDiscoveryServiceHandler) FetchRoutes(context.Context, *connect.Request[v31.DiscoveryRequest]) (*connect.Response[v31.DiscoveryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.route.v3.RouteDiscoveryService.FetchRoutes is not implemented"))
}

// VirtualHostDiscoveryServiceClient is a client for the
// envoy.service.route.v3.VirtualHostDiscoveryService service.
...
// envoy.service.route.v3.VirtualHostDiscoveryService service. By default, it uses the Connect
...
func NewVirtualHostDiscoveryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VirtualHostDiscoveryServiceClient {
	...
	return &virtualHostDiscoveryServiceClient{
		deltaVirtualHosts: connect.NewClient[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse](
			httpClient,
...
type virtualHostDiscoveryServiceClient struct {
	deltaVirtualHosts *connect.Client[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse]
}

// DeltaVirtualHosts calls envoy.service.route.v3.VirtualHostDiscoveryService.DeltaVirtualHosts.
func (c *virtualHostDiscoveryServiceClient) DeltaVirtualHosts(ctx context.Context) *connect.BidiStreamForClient[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse] {
...
func NewVirtualHostDiscoveryServiceHandler(svc VirtualHostDiscoveryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.service.route.v3.VirtualHostDiscoveryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVirtualHostDiscoveryServiceHandler) DeltaVirtualHosts(context.Context, *connect.BidiStream[v31.DeltaDiscoveryRequest, v31.DeltaDiscoveryResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.route.v3.VirtualHostDiscoveryService.DeltaVirtualHosts is not implemented"))
}
