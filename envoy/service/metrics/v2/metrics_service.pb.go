...
var file_envoy_service_metrics_v2_metrics_service_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x88, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06,
...
func file_envoy_service_metrics_v2_metrics_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_metrics_v2_metrics_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_metrics_v2_metrics_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_metrics_v2_metrics_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
