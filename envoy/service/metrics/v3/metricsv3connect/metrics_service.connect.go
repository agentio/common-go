...
package metricsv3connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v3 "github.com/agentio/common-go/envoy/service/metrics/v3"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// StreamMetrics RPC.
	MetricsServiceStreamMetricsProcedure = "/envoy.service.metrics.v3.MetricsService/StreamMetrics"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	metricsServiceServiceDescriptor             = v3.File_envoy_service_metrics_v3_metrics_service_proto.Services().ByName("MetricsService")
...
type MetricsServiceClient interface {
	...
	StreamMetrics(context.Context) *connect.ClientStreamForClient[v3.StreamMetricsMessage, v3.StreamMetricsResponse]
}

// NewMetricsServiceClient constructs a client for the envoy.service.metrics.v3.MetricsService
...
func NewMetricsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MetricsServiceClient {
	...
	return &metricsServiceClient{
		streamMetrics: connect.NewClient[v3.StreamMetricsMessage, v3.StreamMetricsResponse](
			httpClient,
...
type metricsServiceClient struct {
	streamMetrics *connect.Client[v3.StreamMetricsMessage, v3.StreamMetricsResponse]
}

// StreamMetrics calls envoy.service.metrics.v3.MetricsService.StreamMetrics.
func (c *metricsServiceClient) StreamMetrics(ctx context.Context) *connect.ClientStreamForClient[v3.StreamMetricsMessage, v3.StreamMetricsResponse] {
	return c.streamMetrics.CallClientStream(ctx)
}

// MetricsServiceHandler is an implementation of the envoy.service.metrics.v3.MetricsService
// service.
type MetricsServiceHandler interface {
	// Envoy will connect and send StreamMetricsMessage messages forever. It does not expect any
	// response to be sent as nothing would be done in the case of failure.
	StreamMetrics(context.Context, *connect.ClientStream[v3.StreamMetricsMessage]) (*connect.Response[v3.StreamMetricsResponse], error)
}
...
func NewMetricsServiceHandler(svc MetricsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.service.metrics.v3.MetricsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMetricsServiceHandler) StreamMetrics(context.Context, *connect.ClientStream[v3.StreamMetricsMessage]) (*connect.Response[v3.StreamMetricsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.metrics.v3.MetricsService.StreamMetrics is not implemented"))
}
