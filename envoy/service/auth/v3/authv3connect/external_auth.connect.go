...
import (
	...
	context "context"
	errors "errors"
	v3 "github.com/agentio/common-go/envoy/service/auth/v3"
	http "net/http"
	strings "strings"
)
...
var (
	authorizationServiceDescriptor     = v3.File_envoy_service_auth_v3_external_auth_proto.Services().ByName("Authorization")
