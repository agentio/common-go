...
const (
	...
	AuthorizationName = "envoy.service.auth.v2.Authorization"
)
...
const (
	...
	AuthorizationCheckProcedure = "/envoy.service.auth.v2.Authorization/Check"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	authorizationServiceDescriptor     = v2.File_envoy_service_auth_v2_external_auth_proto.Services().ByName("Authorization")
	authorizationCheckMethodDescriptor = authorizationServiceDescriptor.Methods().ByName("Check")
)

// AuthorizationClient is a client for the envoy.service.auth.v2.Authorization service.
...
// NewAuthorizationClient constructs a client for the envoy.service.auth.v2.Authorization service.
...
// Check calls envoy.service.auth.v2.Authorization.Check.
...
// AuthorizationHandler is an implementation of the envoy.service.auth.v2.Authorization service.
...
func NewAuthorizationHandler(svc AuthorizationHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.service.auth.v2.Authorization/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthorizationHandler) Check(context.Context, *connect.Request[v2.CheckRequest]) (*connect.Response[v2.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.auth.v2.Authorization.Check is not implemented"))
}
