...
var file_envoy_service_auth_v2_attribute_context_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x81, 0x01, 0xba, 0x80, 0xc8, 0xd1,
	...
	0x75, 0x74, 0x68, 0x2f, 0x76, 0x32, 0x3b, 0x61, 0x75, 0x74, 0x68, 0x76, 0x32, 0x62, 0x06, 0x70,
...
func file_envoy_service_auth_v2_attribute_context_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_auth_v2_attribute_context_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_auth_v2_attribute_context_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_auth_v2_attribute_context_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_auth_v2_attribute_context_proto_msgTypes[3].Exporter = func(v any, i int) any {
