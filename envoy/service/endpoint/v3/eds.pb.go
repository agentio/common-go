...
var file_envoy_service_endpoint_v3_eds_proto_rawDesc = []byte{
	...
	0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x80, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10,
...
func file_envoy_service_endpoint_v3_eds_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_endpoint_v3_eds_proto_msgTypes[0].Exporter = func(v any, i int) any {
