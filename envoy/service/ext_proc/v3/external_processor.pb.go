...
import (
	...
	v31 "github.com/agentio/common-go/envoy/extensions/filters/http/ext_proc/v3"
	v32 "github.com/agentio/common-go/envoy/type/v3"
...
var file_envoy_service_ext_proc_v3_external_processor_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x8e,
	...
	0x65, 0x73, 0x73, 0x6f, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x41, 0x67, 0x69,
...
func file_envoy_service_ext_proc_v3_external_processor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[12].Exporter = func(v any, i int) any {
	...
	file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_envoy_service_ext_proc_v3_external_processor_proto_msgTypes[12].OneofWrappers = []any{
