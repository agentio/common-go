...
package load_statsv2connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v2 "github.com/agentio/common-go/envoy/service/load_stats/v2"
	http "net/http"
	strings "strings"
)
...
var (
	loadReportingServiceServiceDescriptor               = v2.File_envoy_service_load_stats_v2_lrs_proto.Services().ByName("LoadReportingService")
...
type LoadReportingServiceClient interface {
	...
	StreamLoadStats(context.Context) *connect.BidiStreamForClient[v2.LoadStatsRequest, v2.LoadStatsResponse]
}
...
func NewLoadReportingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) LoadReportingServiceClient {
	...
	return &loadReportingServiceClient{
		streamLoadStats: connect.NewClient[v2.LoadStatsRequest, v2.LoadStatsResponse](
			httpClient,
...
type loadReportingServiceClient struct {
	streamLoadStats *connect.Client[v2.LoadStatsRequest, v2.LoadStatsResponse]
}

// StreamLoadStats calls envoy.service.load_stats.v2.LoadReportingService.StreamLoadStats.
func (c *loadReportingServiceClient) StreamLoadStats(ctx context.Context) *connect.BidiStreamForClient[v2.LoadStatsRequest, v2.LoadStatsResponse] {
...
type LoadReportingServiceHandler interface {
	...
	//     from around the world, computes global assignment and prepares traffic
	//     assignment destined for each zone Envoys are located in. Goto 2.
	StreamLoadStats(context.Context, *connect.BidiStream[v2.LoadStatsRequest, v2.LoadStatsResponse]) error
}
...
func (UnimplementedLoadReportingServiceHandler) StreamLoadStats(context.Context, *connect.BidiStream[v2.LoadStatsRequest, v2.LoadStatsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.load_stats.v2.LoadReportingService.StreamLoadStats is not implemented"))
}
