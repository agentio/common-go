...
package accesslogv3connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v3 "github.com/agentio/common-go/envoy/service/accesslog/v3"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AccessLogServiceStreamAccessLogsProcedure = "/envoy.service.accesslog.v3.AccessLogService/StreamAccessLogs"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	accessLogServiceServiceDescriptor                = v3.File_envoy_service_accesslog_v3_als_proto.Services().ByName("AccessLogService")
...
type AccessLogServiceClient interface {
	...
	StreamAccessLogs(context.Context) *connect.ClientStreamForClient[v3.StreamAccessLogsMessage, v3.StreamAccessLogsResponse]
}
...
func NewAccessLogServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AccessLogServiceClient {
	...
	return &accessLogServiceClient{
		streamAccessLogs: connect.NewClient[v3.StreamAccessLogsMessage, v3.StreamAccessLogsResponse](
			httpClient,
...
type accessLogServiceClient struct {
	streamAccessLogs *connect.Client[v3.StreamAccessLogsMessage, v3.StreamAccessLogsResponse]
}

// StreamAccessLogs calls envoy.service.accesslog.v3.AccessLogService.StreamAccessLogs.
func (c *accessLogServiceClient) StreamAccessLogs(ctx context.Context) *connect.ClientStreamForClient[v3.StreamAccessLogsMessage, v3.StreamAccessLogsResponse] {
	return c.streamAccessLogs.CallClientStream(ctx)
}

// AccessLogServiceHandler is an implementation of the envoy.service.accesslog.v3.AccessLogService
// service.
type AccessLogServiceHandler interface {
	...
	// until it gets an ACK so it could then retry. This API is designed for high throughput with the
	// expectation that it might be lossy.
	StreamAccessLogs(context.Context, *connect.ClientStream[v3.StreamAccessLogsMessage]) (*connect.Response[v3.StreamAccessLogsResponse], error)
}
...
func NewAccessLogServiceHandler(svc AccessLogServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envoy.service.accesslog.v3.AccessLogService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccessLogServiceHandler) StreamAccessLogs(context.Context, *connect.ClientStream[v3.StreamAccessLogsMessage]) (*connect.Response[v3.StreamAccessLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envoy.service.accesslog.v3.AccessLogService.StreamAccessLogs is not implemented"))
}
