...
import (
	...
	v31 "github.com/agentio/common-go/envoy/data/accesslog/v3"
...
var file_envoy_service_accesslog_v3_als_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x83, 0x01, 0xba,
	...
	0x33, 0x42, 0x08, 0x41, 0x6c, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x43, 0x67,
...
func file_envoy_service_accesslog_v3_als_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_accesslog_v3_als_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v3_als_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v3_als_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v3_als_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v3_als_proto_msgTypes[4].Exporter = func(v any, i int) any {
