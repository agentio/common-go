...
import (
	...
	v2 "github.com/agentio/common-go/envoy/data/accesslog/v2"
...
var file_envoy_service_accesslog_v2_als_proto_rawDesc = []byte{
	...
	0x22, 0x00, 0x28, 0x01, 0x42, 0x83, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x01, 0x0a,
	...
	0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x6c, 0x6f, 0x67, 0x2f, 0x76, 0x32, 0x3b, 0x61,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x6c, 0x6f, 0x67, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
func file_envoy_service_accesslog_v2_als_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_accesslog_v2_als_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v2_als_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v2_als_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v2_als_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_service_accesslog_v2_als_proto_msgTypes[4].Exporter = func(v any, i int) any {
