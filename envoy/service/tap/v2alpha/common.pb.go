...
var file_envoy_service_tap_v2alpha_common_proto_rawDesc = []byte{
	...
	0x70, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x93, 0x01, 0xf2, 0x98, 0xfe, 0x8f,
	...
	0x69, 0x63, 0x65, 0x2f, 0x74, 0x61, 0x70, 0x2f, 0x76, 0x32, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x62,
...
func file_envoy_service_tap_v2alpha_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_service_tap_v2alpha_common_proto_msgTypes[8].Exporter = func(v any, i int) any {
