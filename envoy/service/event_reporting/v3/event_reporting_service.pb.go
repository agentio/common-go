...
var file_envoy_service_event_reporting_v3_event_reporting_service_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0xa7,
	...
	0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_service_event_reporting_v3_event_reporting_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_service_event_reporting_v3_event_reporting_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_service_event_reporting_v3_event_reporting_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_service_event_reporting_v3_event_reporting_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
