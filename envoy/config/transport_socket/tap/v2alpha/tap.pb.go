...
import (
	...
	v2alpha "github.com/agentio/common-go/envoy/config/common/tap/v2alpha"
...
var file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x42, 0xc8, 0x01, 0xf2,
	...
	0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e,
...
func file_envoy_config_transport_socket_tap_v2alpha_tap_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_transport_socket_tap_v2alpha_tap_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Tap); i {
			case 0:
				return &v.state
			case 1:
