...
var file_envoy_config_overload_v3_overload_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x72, 0x42, 0x83, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a,
	...
	0x6d, 0x6f, 0x6e, 0x2d, 0x67, 0x6f, 0x2f, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f, 0x63, 0x6f, 0x6e,
...
func file_envoy_config_overload_v3_overload_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_overload_v3_overload_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_config_overload_v3_overload_proto_msgTypes[9].Exporter = func(v any, i int) any {
