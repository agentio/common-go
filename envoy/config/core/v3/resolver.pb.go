...
var file_envoy_config_core_v3_resolver_proto_rawDesc = []byte{
	...
	0x72, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x77, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
	...
	0x6f, 0x72, 0x65, 0x2e, 0x76, 0x33, 0x42, 0x0d, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x72,
...
func file_envoy_config_core_v3_resolver_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_core_v3_resolver_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_resolver_proto_msgTypes[1].Exporter = func(v any, i int) any {
