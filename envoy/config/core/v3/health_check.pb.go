...
var file_envoy_config_core_v3_health_check_proto_rawDesc = []byte{
	...
	0x52, 0x41, 0x44, 0x45, 0x44, 0x10, 0x05, 0x42, 0x7a, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10,
...
func file_envoy_config_core_v3_health_check_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_core_v3_health_check_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_health_check_proto_msgTypes[8].Exporter = func(v any, i int) any {
