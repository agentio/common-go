...
var file_envoy_config_core_v3_socket_option_proto_rawDesc = []byte{
	...
	0x73, 0x42, 0x7b, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x22, 0x69, 0x6f, 0x2e,
	...
	0x11, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f,
...
func file_envoy_config_core_v3_socket_option_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_core_v3_socket_option_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_socket_option_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_socket_option_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_socket_option_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_socket_option_proto_msgTypes[4].Exporter = func(v any, i int) any {
