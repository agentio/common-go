...
var file_envoy_config_core_v3_http_uri_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x76, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
...
func file_envoy_config_core_v3_http_uri_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_core_v3_http_uri_proto_msgTypes[0].Exporter = func(v any, i int) any {
