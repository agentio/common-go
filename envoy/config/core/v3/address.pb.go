...
var file_envoy_config_core_v3_address_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x43, 0x69, 0x64, 0x72, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x42, 0x76, 0xba, 0x80, 0xc8,
	...
	0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75,
...
func file_envoy_config_core_v3_address_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_core_v3_address_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pipe); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_core_v3_address_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_address_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_address_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_address_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_address_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_address_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_address_proto_msgTypes[7].Exporter = func(v any, i int) any {
