...
var file_envoy_config_core_v3_grpc_method_list_proto_rawDesc = []byte{
	...
	0x63, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x7d, 0xba, 0x80, 0xc8,
	...
	0x67, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x33, 0x42, 0x13, 0x47, 0x72, 0x70, 0x63, 0x4d,
	0x65, 0x74, 0x68, 0x6f, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
func file_envoy_config_core_v3_grpc_method_list_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_core_v3_grpc_method_list_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_core_v3_grpc_method_list_proto_msgTypes[1].Exporter = func(v any, i int) any {
