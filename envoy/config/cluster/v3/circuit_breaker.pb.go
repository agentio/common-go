...
var file_envoy_config_cluster_v3_circuit_breaker_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x73, 0x42, 0x86, 0x01, 0xba, 0x80, 0xc8, 0xd1,
...
func file_envoy_config_cluster_v3_circuit_breaker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_cluster_v3_circuit_breaker_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_cluster_v3_circuit_breaker_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_cluster_v3_circuit_breaker_proto_msgTypes[2].Exporter = func(v any, i int) any {
