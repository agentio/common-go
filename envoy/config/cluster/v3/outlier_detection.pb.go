...
var file_envoy_config_cluster_v3_outlier_detection_proto_rawDesc = []byte{
	...
	0x88, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x25, 0x69, 0x6f, 0x2e, 0x65,
...
func file_envoy_config_cluster_v3_outlier_detection_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_cluster_v3_outlier_detection_proto_msgTypes[0].Exporter = func(v any, i int) any {
