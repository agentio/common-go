...
var file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x08, 0x0a, 0x06, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x42, 0xd6, 0x01, 0xf2,
	...
	0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x46, 0x67,
...
func file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Router); i {
			case 0:
				return &v.state
			case 1:
