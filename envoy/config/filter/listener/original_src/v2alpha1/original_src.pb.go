...
var file_envoy_config_filter_listener_original_src_v2alpha1_original_src_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x6d, 0x61, 0x72, 0x6b, 0x42, 0xe8, 0x01, 0xf2, 0x98, 0xfe,
...
func file_envoy_config_filter_listener_original_src_v2alpha1_original_src_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_listener_original_src_v2alpha1_original_src_proto_msgTypes[0].Exporter = func(v any, i int) any {
