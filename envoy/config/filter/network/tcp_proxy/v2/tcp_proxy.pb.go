...
var file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_rawDesc = []byte{
	...
	0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0xd9, 0x01, 0xf2, 0x98,
	...
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_msgTypes[5].Exporter = func(v any, i int) any {
