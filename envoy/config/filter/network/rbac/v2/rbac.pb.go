...
var file_envoy_config_filter_network_rbac_v2_rbac_proto_rawDesc = []byte{
	...
	0x4e, 0x55, 0x4f, 0x55, 0x53, 0x10, 0x01, 0x42, 0xc1, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2a,
	...
	0x63, 0x2f, 0x76, 0x32, 0x3b, 0x72, 0x62, 0x61, 0x63, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
func file_envoy_config_filter_network_rbac_v2_rbac_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_network_rbac_v2_rbac_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RBAC); i {
			case 0:
				return &v.state
			case 1:
