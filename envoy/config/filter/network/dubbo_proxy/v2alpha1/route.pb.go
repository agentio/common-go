...
var file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x42, 0xdc, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x31, 0x12, 0x2f, 0x65, 0x6e,
...
func file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Route); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_msgTypes[5].Exporter = func(v any, i int) any {
