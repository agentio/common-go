...
var file_envoy_config_filter_network_dubbo_proxy_v2alpha1_dubbo_proxy_proto_rawDesc = []byte{
	...
	0x10, 0x00, 0x42, 0xe1, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x31, 0x12, 0x2f, 0x65, 0x6e, 0x76,
...
func file_envoy_config_filter_network_dubbo_proxy_v2alpha1_dubbo_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_dubbo_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_network_dubbo_proxy_v2alpha1_dubbo_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
