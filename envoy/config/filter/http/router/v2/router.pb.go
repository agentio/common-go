...
var file_envoy_config_filter_http_router_v2_router_proto_rawDesc = []byte{
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0xc2, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x29, 0x12, 0x27, 0x65,
	...
	0x3b, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_envoy_config_filter_http_router_v2_router_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_router_v2_router_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Router); i {
			case 0:
				return &v.state
			case 1:
