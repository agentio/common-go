...
var file_envoy_config_filter_http_grpc_stats_v2alpha_config_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0xcf, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2d, 0x12, 0x2b,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x48, 0x67,
...
func file_envoy_config_filter_http_grpc_stats_v2alpha_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_grpc_stats_v2alpha_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_grpc_stats_v2alpha_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
