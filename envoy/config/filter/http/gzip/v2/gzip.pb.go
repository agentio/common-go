...
import (
	v2 "github.com/agentio/common-go/envoy/config/filter/http/compressor/v2"
...
var file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc = []byte{
	...
	0x0a, 0x03, 0x52, 0x4c, 0x45, 0x10, 0x03, 0x42, 0xb8, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x27,
	...
	0x09, 0x47, 0x7a, 0x69, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x44, 0x67, 0x69,
...
func file_envoy_config_filter_http_gzip_v2_gzip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_gzip_v2_gzip_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Gzip); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_filter_http_gzip_v2_gzip_proto_msgTypes[1].Exporter = func(v any, i int) any {
