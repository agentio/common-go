...
var file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_rawDesc = []byte{
	...
	0xd0, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2c, 0x12, 0x2a, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e,
...
func file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_msgTypes[6].Exporter = func(v any, i int) any {
