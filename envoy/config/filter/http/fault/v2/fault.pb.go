...
import (
	...
	v2 "github.com/agentio/common-go/envoy/config/filter/fault/v2"
...
var file_envoy_config_filter_http_fault_v2_fault_proto_rawDesc = []byte{
	...
	0xbd, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x28, 0x12, 0x26, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e,
	...
	0x61, 0x75, 0x6c, 0x74, 0x2f, 0x76, 0x32, 0x3b, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x76, 0x32, 0x62,
...
func file_envoy_config_filter_http_fault_v2_fault_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_fault_v2_fault_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_fault_v2_fault_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_fault_v2_fault_proto_msgTypes[2].Exporter = func(v any, i int) any {
