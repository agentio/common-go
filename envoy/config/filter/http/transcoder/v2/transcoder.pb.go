...
var file_envoy_config_filter_http_transcoder_v2_transcoder_proto_rawDesc = []byte{
	...
	0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0xe0, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x37, 0x12, 0x35,
	...
	0x73, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_config_filter_http_transcoder_v2_transcoder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_transcoder_v2_transcoder_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_transcoder_v2_transcoder_proto_msgTypes[1].Exporter = func(v any, i int) any {
