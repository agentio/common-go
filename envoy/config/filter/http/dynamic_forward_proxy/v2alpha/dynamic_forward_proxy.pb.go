...
import (
	v2alpha "github.com/agentio/common-go/envoy/config/common/dynamic_forward_proxy/v2alpha"
...
var file_envoy_config_filter_http_dynamic_forward_proxy_v2alpha_dynamic_forward_proxy_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0xfd, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x38,
...
func file_envoy_config_filter_http_dynamic_forward_proxy_v2alpha_dynamic_forward_proxy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_dynamic_forward_proxy_v2alpha_dynamic_forward_proxy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_dynamic_forward_proxy_v2alpha_dynamic_forward_proxy_proto_msgTypes[1].Exporter = func(v any, i int) any {
