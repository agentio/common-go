...
var file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_rawDesc = []byte{
	...
	0x67, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0xfa, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x37, 0x12,
	...
	0x52, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e,
...
func file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_msgTypes[3].Exporter = func(v any, i int) any {
