...
var file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x0a, 0x0a, 0x06, 0x42, 0x41, 0x53, 0x45, 0x36, 0x34, 0x10, 0x01, 0x42, 0xfc, 0x01,
	...
	0x61, 0x74, 0x61, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x60, 0x67, 0x69, 0x74, 0x68,
	...
	0x6f, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_msgTypes[2].Exporter = func(v any, i int) any {
