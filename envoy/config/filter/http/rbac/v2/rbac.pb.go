...
import (
	v2 "github.com/agentio/common-go/envoy/config/rbac/v2"
...
var file_envoy_config_filter_http_rbac_v2_rbac_proto_rawDesc = []byte{
	...
	0x72, 0x62, 0x61, 0x63, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x42, 0xb8, 0x01, 0xf2, 0x98, 0xfe,
	...
	0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x67, 0x65, 0x6e,
...
func file_envoy_config_filter_http_rbac_v2_rbac_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_filter_http_rbac_v2_rbac_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RBAC); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_filter_http_rbac_v2_rbac_proto_msgTypes[1].Exporter = func(v any, i int) any {
