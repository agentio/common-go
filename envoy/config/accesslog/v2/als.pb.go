...
var file_envoy_config_accesslog_v2_als_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x42, 0xb0, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x29, 0x12, 0x27, 0x65, 0x6e, 0x76,
	...
	0x6c, 0x6f, 0x67, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_config_accesslog_v2_als_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_accesslog_v2_als_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_accesslog_v2_als_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_accesslog_v2_als_proto_msgTypes[2].Exporter = func(v any, i int) any {
