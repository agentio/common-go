...
var file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDesc = []byte{
	...
	0xf4, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x33, 0x12, 0x31, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e,
...
func file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
