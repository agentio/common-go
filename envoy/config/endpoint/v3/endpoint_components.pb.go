...
var file_envoy_config_endpoint_v3_endpoint_components_proto_rawDesc = []byte{
	...
	0x42, 0x0b, 0x0a, 0x09, 0x6c, 0x62, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x8d, 0x01,
	...
	0x76, 0x33, 0x3b, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x76, 0x33, 0x62, 0x06, 0x70,
...
func file_envoy_config_endpoint_v3_endpoint_components_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_envoy_config_endpoint_v3_endpoint_components_proto_msgTypes[3].OneofWrappers = []any{
