...
var file_envoy_config_endpoint_v3_endpoint_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x42, 0x83, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x26, 0x69,
...
func file_envoy_config_endpoint_v3_endpoint_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_endpoint_v3_endpoint_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_endpoint_v3_endpoint_proto_msgTypes[3].Exporter = func(v any, i int) any {
