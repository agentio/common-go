...
var file_envoy_config_listener_v3_udp_listener_config_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x8c, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06,
...
func file_envoy_config_listener_v3_udp_listener_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_listener_v3_udp_listener_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_udp_listener_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
