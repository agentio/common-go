...
import (
	...
	v33 "github.com/agentio/common-go/envoy/config/accesslog/v3"
...
var file_envoy_config_listener_v3_listener_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x42, 0x83, 0x01, 0xba, 0x80, 0xc8, 0xd1,
	...
	0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x40, 0x67,
	...
	0x72, 0x2f, 0x76, 0x33, 0x3b, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x76, 0x33, 0x62,
...
func file_envoy_config_listener_v3_listener_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_listener_v3_listener_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_config_listener_v3_listener_proto_msgTypes[9].Exporter = func(v any, i int) any {
