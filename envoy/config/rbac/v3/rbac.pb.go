...
import (
	...
	v31 "github.com/agentio/common-go/envoy/type/matcher/v3"
...
var file_envoy_config_rbac_v3_rbac_proto_rawDesc = []byte{
	...
	0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x73, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10,
...
func file_envoy_config_rbac_v3_rbac_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RBAC); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Policy); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_config_rbac_v3_rbac_proto_msgTypes[10].Exporter = func(v any, i int) any {
	...
	file_envoy_config_rbac_v3_rbac_proto_msgTypes[2].OneofWrappers = []any{
