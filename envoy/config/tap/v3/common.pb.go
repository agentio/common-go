...
import (
	...
	v3 "github.com/agentio/common-go/envoy/config/common/matcher/v3"
...
var file_envoy_config_tap_v3_common_proto_rawDesc = []byte{
	...
	0x42, 0x72, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0x0a, 0x21, 0x69, 0x6f, 0x2e, 0x65,
	...
	0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x74, 0x61, 0x70, 0x2f, 0x76, 0x33, 0x3b, 0x74,
	0x61, 0x70, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_config_tap_v3_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_tap_v3_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_envoy_config_tap_v3_common_proto_msgTypes[11].Exporter = func(v any, i int) any {
