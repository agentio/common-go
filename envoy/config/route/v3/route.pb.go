...
var file_envoy_config_route_v3_route_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x56, 0x68, 0x64, 0x73, 0x42, 0x77, 0xba, 0x80, 0xc8, 0xd1,
	...
	0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x33, 0x42, 0x0a, 0x52, 0x6f, 0x75, 0x74, 0x65,
...
func file_envoy_config_route_v3_route_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_route_v3_route_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_route_v3_route_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Vhds); i {
			case 0:
				return &v.state
			case 1:
