...
import (
	...
	v3 "github.com/agentio/common-go/envoy/config/route/v3"
...
var file_envoy_config_common_matcher_v3_matcher_proto_rawDesc = []byte{
	...
	0x68, 0x42, 0x0b, 0x0a, 0x04, 0x72, 0x75, 0x6c, 0x65, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x8d,
	...
	0x72, 0x2f, 0x76, 0x33, 0x3b, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x76, 0x33, 0x62, 0x06,
...
func file_envoy_config_common_matcher_v3_matcher_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_envoy_config_common_matcher_v3_matcher_proto_msgTypes[14].Exporter = func(v any, i int) any {
