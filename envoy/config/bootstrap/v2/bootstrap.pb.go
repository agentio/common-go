...
import (
	...
	v22 "github.com/agentio/common-go/envoy/api/v2"
	auth "github.com/agentio/common-go/envoy/api/v2/auth"
	core "github.com/agentio/common-go/envoy/api/v2/core"
	v2 "github.com/agentio/common-go/envoy/config/metrics/v2"
	v2alpha "github.com/agentio/common-go/envoy/config/overload/v2alpha"
	v21 "github.com/agentio/common-go/envoy/config/trace/v2"
...
var file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc = []byte{
	...
	0x61, 0x79, 0x65, 0x72, 0x52, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x42, 0x87, 0x01, 0xba,
	...
	0x74, 0x72, 0x61, 0x70, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_envoy_config_bootstrap_v2_bootstrap_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Admin); i {
			case 0:
				return &v.state
			case 1:
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[12].Exporter = func(v any, i int) any {
