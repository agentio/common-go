...
var file_envoy_config_ratelimit_v2_rls_proto_rawDesc = []byte{
	...
	0x04, 0x42, 0x81, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x01, 0x0a, 0x27, 0x69, 0x6f,
...
func file_envoy_config_ratelimit_v2_rls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_ratelimit_v2_rls_proto_msgTypes[0].Exporter = func(v any, i int) any {
