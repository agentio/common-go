...
var file_envoy_config_metrics_v3_metrics_service_proto_rawDesc = []byte{
	...
	0x09, 0x48, 0x49, 0x53, 0x54, 0x4f, 0x47, 0x52, 0x41, 0x4d, 0x10, 0x02, 0x42, 0x86, 0x01, 0xba,
...
func file_envoy_config_metrics_v3_metrics_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_metrics_v3_metrics_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
