...
var file_envoy_config_trace_v3_opencensus_proto_rawDesc = []byte{
	...
	0x42, 0xaf, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2d, 0x12, 0x2b, 0x65, 0x6e, 0x76, 0x6f, 0x79,
...
var file_envoy_config_trace_v3_opencensus_proto_goTypes = []any{
...
func file_envoy_config_trace_v3_opencensus_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_trace_v3_opencensus_proto_msgTypes[0].Exporter = func(v any, i int) any {
