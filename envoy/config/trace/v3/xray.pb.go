...
var file_envoy_config_trace_v3_xray_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x42, 0xa3, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x27, 0x12, 0x25, 0x65, 0x6e, 0x76,
	...
	0x09, 0x58, 0x72, 0x61, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69,
...
func file_envoy_config_trace_v3_xray_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_trace_v3_xray_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_trace_v3_xray_proto_msgTypes[1].Exporter = func(v any, i int) any {
