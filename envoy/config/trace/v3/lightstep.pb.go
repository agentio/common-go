...
var file_envoy_config_trace_v3_lightstep_proto_rawDesc = []byte{
	...
	0x67, 0x42, 0xad, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2c, 0x12, 0x2a, 0x65, 0x6e, 0x76, 0x6f,
...
func file_envoy_config_trace_v3_lightstep_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_trace_v3_lightstep_proto_msgTypes[0].Exporter = func(v any, i int) any {
