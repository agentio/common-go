...
var file_envoy_config_trace_v3_datadog_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x42, 0xa9, 0x01, 0xf2, 0x98, 0xfe, 0x8f, 0x05, 0x2a, 0x12, 0x28, 0x65,
...
func file_envoy_config_trace_v3_datadog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_envoy_config_trace_v3_datadog_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_envoy_config_trace_v3_datadog_proto_msgTypes[1].Exporter = func(v any, i int) any {
